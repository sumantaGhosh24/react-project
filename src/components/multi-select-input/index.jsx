...
const MultiSelectInput = () => {
  ...
  return (
    <>
      <BackHome title="Multi Select Input" />
      <div className="msi__container">
        <div className="msi__pills">
        ...
        <div className="msi__form">
          <input
            ...
            className="msi__input"
          />
          <ul className="msi__list">
            {suggestions?.users?.map((user, index) => {
              return !selectedUserSet.has(user.email) ? (
                <li
                  className={
                    index === activeSuggestion
                      ? "msi__item msi__item--active"
                      : "msi__item"
                  }
                  key={user.email}
